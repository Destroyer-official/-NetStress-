"""
Real protocol packet generators.

This module contains implementations for generating real network protocol packets
without any simulations or fake implementations.
"""
