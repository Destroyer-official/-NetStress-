...
pub enum BackendType {
    ...
    AfXdp = 4,
    Dpdk = 5,
    IOCP = 6,         // Windows I/O Completion Ports
    RegisteredIO = 7, // Windows Registered I/O
    Kqueue = 8,       // macOS kqueue
}
...
impl BackendType {
    ...
    pub fn from_u32(v: u32) -> Self {
        match v {
            ...
            5 => BackendType::Dpdk,
            6 => BackendType::IOCP,
            7 => BackendType::RegisteredIO,
            8 => BackendType::Kqueue,
            _ => BackendType::None,
        }
    }
}
...
pub fn create_best_backend() -> Box<dyn Backend> {
    ...
    #[cfg(target_os = "macos")]
    {
        if backend_type == BackendType::Kqueue {
